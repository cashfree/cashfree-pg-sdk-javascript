        ...
        1736: (t, r, a) => {
            ...
            Xt = {
              ...
              fontPreferences: function getFontPreferences() {
                return (function withNaturalFonts(t, r) {
                  ...
                  for (var w = 0, S = Object.keys(Vt); w < S.length; w++) {
          ...
          var sn = (function () {
            ...
            Sn = function checkPaymentRequestValidity(t, r) {
              if (!yn(t.bankCode)) throw new Ue("invalid bank code", xe);
                ...
                _defineProperty(this, "element", function (t) {
                  try {
                    switch (
                      ...
                      case "netbanking":
                        return (
                          (r._netBanking = new xn(t.pay, t.onChange)),
