    ...
    var t = {
          ...
          function eventFromUnknownInput(t, r, a, o, c) {
            ...
            if ((0, N.TX)(r) || (0, N.fm)(r)) {
              ...
              if ("stack" in r) u = eventFromError(t, r);
                ...
                (u = eventFromString(t, p, a, o)), (0, x.Db)(u, p);
              }
              return (
                "code" in l &&
          ...
          class BaseClient {
            ...
            _applyClientOptions(t) {
              ...
              "environment" in t ||
                ...
                t.message && (t.message = (0, w.$G)(t.message, u));
              var l =
                t.exception && t.exception.values && t.exception.values[0];
              l && l.value && (l.value = (0, w.$G)(l.value, u));
              var d = t.request;
              d && d.url && (d.url = (0, w.$G)(d.url, u));
            }
            ...
            (function () {
              var t = asyncToGenerator_asyncToGenerator(
                c().mark(function _callee(t, r, a, o, u) {
                  var l, d, p, h, m, _, g, v, y, b, E, x, w, S, A;
                  return c().wrap(function _callee$(c) {
                    for (;;)
                      switch ((c.prev = c.next)) {
                        case 0:
              ...
              fontPreferences: function getFontPreferences() {
                return (function withNaturalFonts(t, r) {
                  ...
                  for (var x = 0, w = Object.keys(Xt); x < w.length; x++) {
                    o[(l = w[x])] = a[l].getBoundingClientRect().width;
                  }
                  return o;
                });
              },
          ...
          const Jt = {
            ...
            Zt = function track(t, r) {
              ...
              return asyncToGenerator_asyncToGenerator(
                c().mark(function _callee() {
                  var o, u, l, d, p, h, m, _, g, v, y, b, E, x, w;
                  return c().wrap(function _callee$(c) {
                    for (;;)
                      switch ((c.prev = c.next)) {
                        case 0:
                        ...
                        case 8:
                          (l = c.sent),
                            ...
                            fetch(
                              ""
                                .concat(
                                  "https://payments-test.cashfree.com/pgbillpayuiapi",
                                  "/analytics/"
                                )
                                .concat(o, "/track"),
                              {
          ...
          t.exports = function from(t) {
            ...
            if (
              ...
              for (
                ...
                (y = S ? u(g, w, [_.value, k], !0) : _.value), p(a, k, y);
            return (a.length = k), a;
          };
        },
        1318: (t, r, a) => {
        ...
        9653: (t, r, a) => {
          ...
          if (u(w, !S(" 0o1") || !S("0b1") || S("+0x1"))) {
            ...
            (T.prototype = A), (A.constructor = T), l(c, w, T);
          }
        },
        9601: (t, r, a) => {
          var o = a(2109),
                  ...
                  ee = function fillGapTarget(t) {
                    ...
                    if (c(t)) {
                      ...
                      if (
                        ...
                        var o = p(t, l(w.lockableSelectors));
                        a = T(o, !0);
                      }
                      "true" ===
...
//# sourceMappingURL=dropinClient.sandbox.js.map
